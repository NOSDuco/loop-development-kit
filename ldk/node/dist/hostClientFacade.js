...
const configurationClient_1 = __importDefault(require("./hostClients/configurationClient"));
...
class HostClientFacade {
    ...
    constructor(logger) {
        ...
        this.configuration = new configurationClient_1.default();
    ...
    connect(connInfo, session) {
        return Promise.all([
            ...
            this.configuration.connect(connInfo, session, this.logger),
